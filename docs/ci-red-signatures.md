...
| occurrences | five: three on 2026-08-31 within eleven hours, the third on `main` after a documentation-only merge; two more on 2026-09-08 in local six-stage sweeps thirty-six minutes apart (gate logs `20260908T101700Z-2279879` and `20260908T105335Z-2697918`, step `05-sweep`, each `2199 passed; 1 failed`), both fragments present, on a branch touching neither `packages` nor `file_io`. Six intervening sweeps of the same tree were green, so the rate on this machine is neither zero nor one |
